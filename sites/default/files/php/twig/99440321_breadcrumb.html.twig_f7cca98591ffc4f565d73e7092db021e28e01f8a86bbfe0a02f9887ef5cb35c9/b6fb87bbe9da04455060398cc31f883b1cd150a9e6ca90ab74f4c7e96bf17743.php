...
class __TwigTemplate_4db1b17b57a632db4f78b4c34a2f7f5fc556e51b1a361c92f38ef0bc81fde4e5 extends Twig_Template
{
    ...
    ";
        ...
        ";
                // line 16
                if (twig_template_get_attributes($this, $context["item"], "url", array())) {
                    // line 17
                    echo "          <a href=\"";
                    echo $this->env->getExtension('sandbox')->ensureToStringAllowed($this->env->getExtension('drupal_core')->escapeFilter($this->env, twig_template_get_attributes($this, $context["item"], "url", array()), "html", null, true));
                    echo "\">";
